...
def get_args():
    ...
    parser.add_argument('-t', '--test', help='Specify whether to use ENA test server for submission. When using this parameter, specify true/T/t.', choices=['true', 'T', 't', 'false', 'F', 'f'], required=False)
